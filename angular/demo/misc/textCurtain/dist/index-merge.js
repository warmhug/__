 ...
 */
angular.module('textCurtain-0.1.0', []).directive('textCurtain', [function () {
    return {
      compile: function (element, attrs) {
        ...
        var minNumChars = angular.isDefined(attrs.curtainMinChars) ? attrs.curtainMinChars : 0;
        // fixed vars
            ...
            button.find('a').click(function (e) {
              if (element.css('overflow') == 'hidden') {
                ...
                if (bodyTopPosition > elTopPosition) {
                  $('html, body').animate({ scrollTop: elTopPosition - 20 }, 'slow');
                }
